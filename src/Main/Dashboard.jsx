...
const Dashboard = () => {
    ...
    return (
        <>
            ...
            <div className="drawer lg:drawer-open max-h-fit ">
                <input id="my-drawer-2" type="checkbox" className="drawer-toggle" />
                <div className="drawer-content flex flex-col  justify-center px-10 ">

                    <Outlet></Outlet>
                    <label htmlFor="my-drawer-2" className="btn btn-primary drawer-button lg:hidden">Open drawer</label>

                </div>
                <div className="drawer-side bg-[#020822]  rounded-lg text-white font-bold ml-5 fixed ">
                    ...
                    <ul className="menu p-4 w-80 space-y-4">

                        {
                            isAdmin ? (<div>
                                ...
                                <h1 className='font-bold text-4xl py-4 '>Admin Dashboard</h1>
                                ...
                                isInstractor ? (<div>
                                    ...
                                    (<div>
                                        <>
                                            ...
                                            >
                                                <span className='text-center flex justify-center items-center'>
                                                    {user?.photoURL ? <img style={{ width: "120px", height: "120px", borderRadius: "50%" }} src={user?.photoURL} alt='' />
                                                        : ""
                                                    }</span>
                                                <div className=' font-bold'>
                                                    <h1 className='text-2xl text-center' style={{ letterSpacing: "8px", textAlign: 'center' }}>WELCOME</h1>
